  ...
  try {
    ...
    switch (exportFormat.value) {
      case "csv":
        ...
        break;
      case "json":
        result = await exportToJSON(null, options);
        break;
      case "png":
    ...
    <div class="max-w-4xl mx-auto p-4 lg:p-6">
      ...
      <div class="glass-card p-6 space-y-8">
        ...
        <ExportPreview
          ...
          :formatDate="settingsStore.formatDate"
        />
      ...
      <div class="mt-8 glass-card p-6">
        ...
        <input
          type="file"
          accept=".json"
          class="w-full bg-white/5 rounded-xl p-4 text-white file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-primary file:text-white file:font-medium file:cursor-pointer cursor-pointer focus:ring-2 focus:ring-primary/20 transition-all"
        />
